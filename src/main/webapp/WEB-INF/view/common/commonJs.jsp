<script type="text/javascript" src="${resourceToolsUrl}/jquery/jquery-3.1.1.js"></script>
<!--含其他工具-->
<script type="text/javascript" src="${resourceUrl}/js/common/common.js"></script>

<script type="text/javascript" src="${resourceUrl}/js/common/basePage.js"></script>
